    ...
    public void onBindViewHolder(TopSongsViewHolder holder, int position) {
     ...
     holder.llContainer.setOnClickListener(new View.OnClickListener(){
         ...
         public void onClick (View view){
             ...
             intent.putExtra(SongsDetailsActivity.TRACK,single.strTrack);
             intent.putExtra(SongsDetailsActivity.ARTIST,single.strArtist);
             intent.putExtra(SongsDetailsActivity.TRACK_ID,single.idTrack);
